 ...
 *      pred(param, elem)
 *      All elements of V copied in returned vector are set to 0
 *      V can be deleted with vs_vector_del
 */
 ...
 *      All elements of V1 and V2 are set to 0
 *      V1 and V2 can be deleted with vs_vector_del
 */
